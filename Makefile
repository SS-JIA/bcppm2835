...
build/bcppm2835.o: build/bcm2835base.o build/bcm2835spi.o build/bcm2835gpio.o
	$(AR) r build/bcppm2835.o build/bcm2835base.o build/bcm2835spi.o build/bcm2835gpio.o
